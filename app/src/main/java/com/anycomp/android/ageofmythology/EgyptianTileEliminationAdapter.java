...
/**
 * Created by moat on 5/2/15.
 */
public class EgyptianTileEliminationAdapter extends BaseAdapter {
    private Context context;
    ArrayList<Tile> tiles;

    public EgyptianTileEliminationAdapter(Context context, TileEliminationController tec) {
        this.context = context;
        tiles = tec.getEgyptianTiles();
    }
