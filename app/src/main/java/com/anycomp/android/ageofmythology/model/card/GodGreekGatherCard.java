...
/**
 * Created by bert on 4/30/15.
 */
public class GodGreekGatherCard extends RandomGatherCard implements God {
    public GodGreekGatherCard(PermanentGatherCard card) {
        setName("GodGreekGather");
        this.card = card;
        setImagePath(R.drawable.card_rand_greek_gather_poseidon);
        favorCost = 1;
    }
