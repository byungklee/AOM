 ...
 */
public class GodNorseTradeCard extends RandomTradeCard implements God {

    private static final String TAG = "GodNorseTrade";

    public GodNorseTradeCard(RandomTradeCard card) {
        setName(TAG);
        this.card=card;
        setImagePath(R.drawable.card_rand_norse_trade_forseti);
        setValue(0);
